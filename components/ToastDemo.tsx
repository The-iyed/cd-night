...
export interface IToastDemo {
    native: boolean;
    setNative: React.Dispatch<React.SetStateAction<boolean>>
    message?:string
}
export const ToastDemo = ({native,setNative,message}:IToastDemo) => {

  return (

    <YStack space alignItems="center">

      <ToastControl native={native} message={message} />
...
const ToastControl = ({ native, message }: { native: boolean  , message?:string }) => {
